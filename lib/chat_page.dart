...
import 'package:msn/buzz_container.dart';
import 'package:msn/models/message.dart';
import 'package:msn/models/profile.dart';
      ...
      body: StreamBuilder<List<Message>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            final isMine = messages.isNotEmpty && messages.first.isMine;
